...
___
### Нативное CLI приложение наптсанное с помощью Picocli для парсера log файлов.
...
* param2 - запрос, три вида запроса
  * ```get <field1>```
  * ```get <field1> for <field2> = <value>``` (данный запрос выведет список всех ip для UserName)
